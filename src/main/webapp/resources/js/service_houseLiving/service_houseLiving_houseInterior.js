...
function nextPage(){
    console.log("@@@@@@@@@@@@@ value : "+Number(document.getElementById('value').value));
    console.log("@@@@@@@@@@@@@ value : "+value[Number(document.getElementById('value').value)]);
    ...
    switch(document.getElementById('value').value){
        case '0': 
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_progress" class="radio" value="디자인 인테리어"><p>디자인 인테리어</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="실내 증축"><p>실내 증축</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="부분 인테리어"><p>부분 인테리어</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="올리모델링"><p>올리모델링</p></div>';
            ...
            document.getElementById('selectBarAni').animate([
                ...
                document.getElementById('selectBarPercent').innerText = '20%';
                count = 0;
            break;
        case '3':
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
                document.getElementById('selectBarPercent').innerText = '40%';
                count = 3;
            break;
        case '4':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `작업받기 좋은 요일은 언제인가요?`;
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
                document.getElementById('selectBarPercent').innerText = '60%';
            break;
        case '5':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `희망하는 시간대는 언제인가요?`;
            ...
            break;
        case '6':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `작업할 희망 지역을 선택해주세요.`;
...
function prevPage(){
    ...
    switch(document.getElementById('value').value){
        case '3': 
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `건물 유형이 어떻게 되나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_purpose" class="radio" value="아파트" onclick="etcRedo()"><p>아파트</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="빌라/연립주택" onclick="etcRedo()"><p>빌라/연립주택</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="단독주택" onclick="etcRedo()"><p>단독주택</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="오피스텔" onclick="etcRedo()"><p>오피스텔</p></div>';
        ...
        case '4':
            ...
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="실내 증축"><p>실내 증축</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="부분 인테리어"><p>부분 인테리어</p></div>';
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="올리모델링"><p>올리모델링</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
            document.getElementById('value').value = 3;
            count = 3;
            document.getElementById('selectBarAni').animate([    
    ...
    console.log(`${Number(document.getElementById('value').value)}번째 배열 : `+value[count-1]);
    console.log('배열의 모든 값 : '+value);
    if(document.getElementById('value').value == 5){
        console.log("day : "+day);
        ...
        console.log(value[Number(count)]);
