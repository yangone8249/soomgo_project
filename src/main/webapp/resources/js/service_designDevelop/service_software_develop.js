...
function nextPage(){
    ...
    for(let i=0; i<document.getElementsByClassName('selectLi').length; i++){
        ...
        if(document.getElementsByClassName('selectLi')[i].childNodes[0].childNodes[0].checked){
            ...
            if(document.getElementById('value').value == 0 && value[Number(document.getElementById('value').value)] == 4){
                    ...
                    console.log(Number(document.getElementById('value').value));
                    console.log(document.getElementById('inputEtc').value);
    ...
    if(document.getElementById('value').value == 0 && value[0] == document.getElementsByClassName('selectLi').length-1){
        if(document.getElementById('inputEtc').value.trim().length > 0 ){
            ...
            document.getElementsByClassName("selectLi")[6].childNodes[0].style.height = "140px";
            return;
        }
    }
    if(Number(document.getElementById('value').value)==7){
    ...
    switch(document.getElementById('value').value){
        case '0': 
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `어떤 종류의 개발을 원하시나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_progress" class="radio" value="일반 프로그램"><p>일반 프로그램</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="게임"><p>게임</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="웹 개발"><p>웹 개발</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="임베디드"><p>임베디드</p></div>';
            document.getElementsByClassName('selectLi')[4].innerHTML = '<div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="기타"><p>기타</p></div>';
            ...
            document.getElementById('selectBarAni').animate([
                ...
                document.getElementById('selectBarPercent').innerText = '16%';
            break;
        case '1':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `원하는 숙련도의 개발자가 있으신가요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="상담 후 결정"><p>상담 후 결정</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="주니어 (3년 이하)"><p>주니어 (3년 이하)</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="미드 (4~9년)"><p>미드 (4~9년)</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div id="lastSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="시니어 (10년 이상)"><p>시니어 (10년 이상)</p></div>';
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
            document.getElementById('selectBarPercent').innerText = '32%';
            break;
        case '2':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `기획은 어느 정도 되어있나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="아이디어만 있음"><p>아이디어만 있음</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="필요 내용 정리되어 있음"><p>필요 내용 정리되어 있음</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="상세한 기획 문서 있음"><p>상세한 기획 문서 있음</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="레이아웃, 디자인 등 구성 완료됨"><p>레이아웃, 디자인 등 구성 완료됨</p></div>';
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="없음"><p>없음</p></div></li>`;
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
            document.getElementById('selectBarPercent').innerText = '48%';
            break;
        case '4':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `상담받기 좋은 요일은 언제인가요?`;
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
                document.getElementById('selectBarPercent').innerText = '64%';
            break;
        case '5':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `희망하는 미팅 시간대는 언제인가요?`;
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
                document.getElementById('selectBarPercent').innerText = '80%';
            break;
        case '6':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `미팅할 희망 지역을 선택해주세요.`;
...
function prevPage(){
    ...
    switch(document.getElementById('value').value){
        case '1': 
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `어떤 플랫폼을 원하시나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="Windows"><p>Windows</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="Mac"><p>Mac</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="Linux"><p>Linux</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="iOS"><p>iOS</p></div>';
            document.getElementsByClassName('selectLi')[4].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="Android"><p>Android</p></div>';
            label1.innerHTML = `<li class="selectLi"><div><input type="radio" name="estimate_purpose" class="radio" onclick="etcRedo()" value="고수와 상담 후 결정할게요."><p>고수와 상담 후 결정할게요.</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
            label2.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_purpose" class="radio" value="" onclick="etcEvent()" id="etc"><p>기타</p></div></li>`;
            document.getElementById('selectUl').appendChild(label2);
        ...
        case '2':
            ...
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="웹 개발"><p>웹 개발</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="임베디드"><p>임베디드</p></div>';
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_purpose" class="radio" id="etc" onclick="etcEvent()"><p>기타</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
            document.getElementById('value').value = 1;
            document.getElementById('selectBarAni').animate([    
                { width: "75px"} 
        ...
        case '4':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `원하는 숙련도의 개발자가 있으신가요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = `<div id="firstSelectLi"><input type="radio" name="estimate_ugender" class="radio" value="상담 후 결정"><p>상담 후 결정</p></div>`;
            document.getElementsByClassName('selectLi')[1].innerHTML = `<div><input type="radio" name="estimate_ugender" class="radio" value="주니어 (3년 이하)"><p>주니어 (3년 이하)</p></div>`;
            document.getElementsByClassName('selectLi')[2].innerHTML = `<div><input type="radio" name="estimate_ugender" class="radio" value="미드 (4~9년)"><p>미드 (4~9년)</p></div>`;
            document.getElementsByClassName('selectLi')[3].innerHTML = `<div id="lastSelectLi"><input type="radio" name="estimate_ugender" class="radio" value="시니어 (10년 이상)"><p>시니어 (10년 이상)</p></div>`;
            document.getElementsByClassName('selectLi')[4].remove();
            document.getElementsByTagName('label')[4].remove();
            document.getElementById('value').value = 2;
            document.getElementById('selectBarAni').animate([    
        ...
        case '5':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `기획은 어느 정도 되어있나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = `<div id="firstSelectLi"><input type="radio" name="estimate_mgender" class="radio" value="아이디어만 있음"><p>아이디어만 있음</p></div>`;
            document.getElementsByClassName('selectLi')[1].innerHTML = `<div><input type="radio" name="estimate_mgender" class="radio" value="필요 내용 정리되어 있음"><p>필요 내용 정리되어 있음</p></div>`;
            document.getElementsByClassName('selectLi')[2].innerHTML = `<div><input type="radio" name="estimate_mgender" class="radio" value="상세한 기획 문서 있음"><p>상세한 기획 문서 있음</p></div>`;
            document.getElementsByClassName('selectLi')[3].innerHTML = `<div><input type="radio" name="estimate_mgender" class="radio" value="레이아웃, 디자인 등 구성 완료됨"><p>레이아웃, 디자인 등 구성 완료됨</p></div>`;
            document.getElementsByClassName('selectLi')[4].innerHTML = `<div id="lastSelectLi"><input type="radio" name="estimate_mgender" class="radio" value="없음"><p>없음</p></div>`;
            document.getElementsByClassName('selectLi')[6].remove();
            document.getElementsByTagName('label')[6].remove();
            document.getElementsByClassName('selectLi')[5].remove();
            document.getElementsByTagName('label')[5].remove();
...
function etcRedo(){
    document.getElementsByClassName('selectLi')[6].innerHTML = `<div id="lastSelectLi"><input type="radio" name="radio" class="radio" id="etc" onclick="etcEvent()"><p>기타</p></div>`;
}

function etcEvent(){
        console.log(document.getElementsByClassName("selectLi")[6].childNodes[0].childNodes[0]);
        document.getElementsByClassName('selectLi')[6].innerHTML = `<div id="lastSelectLi"><input type="radio" name="estimate_purpose" class="radio" onclick="etcEvent()" checked><p>기타</p>
        <input type="text" placeholder="직접 입력" id="inputEtc" onfocus="inputEtcEvent()" value=""/></div>`;
        document.getElementsByClassName("selectLi")[6].childNodes[0].style.height = "120px";
}
