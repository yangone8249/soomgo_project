...
function nextPage(){
    ...
    console.log("@@@@@@@@@@@@@ value : "+value[Number(count)]);
    ...
    switch(document.getElementById('value').value){
        case '0': 
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `어떤 서비스를 원하시나요?`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_progress" class="radio" value="세무 상담"><p>세무 상담</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="세무 신고대행"><p>세무 신고대행</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="기장대행"><p>기장대행</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="사업자등록/법인설립 대행"><p>사업자등록/법인설립 대행</p></div>';
            document.getElementsByClassName('selectLi')[4].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="조세 불복"><p>조세 불복</p></div>';
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="회계감사"><p>회계감사</p></div></li>`;
            ...
            document.getElementById('selectBarAni').animate([
                ...
                document.getElementById('selectBarPercent').innerText = '25%';
                count = 0;
            break;
        case '4':
            ...
            document.getElementsByClassName('selectLi')[5].innerHTML = `<div><input type="checkbox" name="estimate_day" class="radio" value="6"><p>토요일</p></div>`;
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="checkbox" name="estimate_day" class="radio" value="0"><p>일요일</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
        ...
        case '5':
            ...
            document.getElementById('selectBarAni').animate([    
                ...
                fill: "forwards", easing: "ease-out"});
                document.getElementById('selectBarPercent').innerText = '75%';
            break;
        case '6':
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `상담받고싶은 희망 지역을 선택해주세요.`;
...
function prevPage(){
    ...
    switch(document.getElementById('value').value){
        case '4': 
            document.getElementById('selectMainBox').getElementsByTagName('h2')[0].innerText = `의뢰인 유형을 선택해주세요.`;
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_purpose" class="radio" value="개인" onclick="etcRedo()"><p>개인</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="개인사업자" onclick="etcRedo()"><p>개인사업자</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="법인사업자" onclick="etcRedo()"><p>법인사업자</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="개업 예정" onclick="etcRedo()"><p>개업 예정</p></div>';
        ...
        case '5':
            ...
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="사업자등록/법인설립 대행"><p>사업자등록/법인설립 대행</p></div>';
            document.getElementsByClassName('selectLi')[4].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="조세 불복"><p>조세 불복</p></div>';
            document.getElementsByClassName('selectLi')[5].innerHTML = '<div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="회계감사"><p>회계감사</p></div>';
            document.getElementsByClassName('selectLi')[6].remove();
            document.getElementsByTagName('label')[6].remove();
            document.getElementById('value').value = 4;
            count = 4;
