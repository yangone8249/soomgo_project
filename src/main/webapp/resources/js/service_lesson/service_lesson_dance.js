...
function nextPage(){
    ...
    switch(document.getElementById('value').value){
        case '0': 
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_progress" class="radio" value="고수가 있는 곳으로 갈게요."><p>고수가 있는 곳으로 갈게요.</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="제가 있는 곳으로 와주세요."><p>제가 있는 곳으로 와주세요.</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_progress" class="radio" value="온라인/화상 수업 원해요."><p>온라인/화상 수업 원해요.</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div id="lastSelectLi"><input type="radio" name="estimate_progress" class="radio" value="어떤 방식이든 상관없어요."><p>어떤 방식이든 상관없어요.</p></div>';
        ...
        case '1':
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="10대 미만"><p>10대 미만</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="10대"><p>10대</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="20대"><p>20대</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="30대"><p>30대</p></div>';
            label1.innerHTML = `<li class="selectLi"><div><input type="radio" name="estimate_agegroup" class="radio" value="40대"><p>40대</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
            label2.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="50대 이상"><p>50대 이상</p></div></li>`;
        ...
        case '2':
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = `<div id="firstSelectLi"><input type="radio" name="estimate_ugender" class="radio" value="남자"><p>남자</p></div>`;
            document.getElementsByClassName('selectLi')[1].innerHTML = `<div id="lastSelectLi"><input type="radio" name="estimate_ugender" class="radio" value="여자"><p>여자</p></div>`;
        ...
        case '3':
            ...
            document.getElementsByClassName('selectLi')[1].innerHTML = `<div><input type="radio" name="estimate_mgender" class="radio" value="남자"><p>남자</p></div>`;
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_mgender" class="radio" value="여자"><p>여자</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
...
function prevPage(){
    ...
    switch(document.getElementById('value').value){
        case '1': 
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_purpose" class="radio" value="취미/다이어트" onclick="etcRedo()"><p>취미/다이어트</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="오디션 준비" onclick="etcRedo()"><p>오디션 준비</p></div>';
            document.getElementsByClassName('selectLi')[2].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="공연/장기자랑 준비" onclick="etcRedo()"><p>공연/장기자랑 준비</p></div>';
            document.getElementsByClassName('selectLi')[3].innerHTML = '<div><input type="radio" name="estimate_purpose" class="radio" value="입시 준비" onclick="etcRedo()"><p>입시 준비</p></div>';
            label1.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_purpose" class="radio" value="" onclick="etcEvent()" id="etc"><p>기타</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
        ...
        case '3':
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = '<div id="firstSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="10대 미만"><p>10대 미만</p></div>';
            document.getElementsByClassName('selectLi')[1].innerHTML = '<div><input type="radio" name="estimate_agegroup" class="radio" value="10대"><p>10대</p></div>';
            label1.innerHTML = `<li class="selectLi"><div><input type="radio" name="estimate_agegroup" class="radio" value="20대"><p>20대</p></div></li>`;
            document.getElementById('selectUl').appendChild(label1);
            label2.innerHTML = `<li class="selectLi"><div><input type="radio" name="estimate_agegroup" class="radio" value="30대"><p>30대</p></div></li>`;
            document.getElementById('selectUl').appendChild(label2);
            label3.innerHTML = `<li class="selectLi"><div><input type="radio" name="estimate_agegroup" class="radio" value="40대"><p>40대</p></div></li>`;
            document.getElementById('selectUl').appendChild(label3);
            label4.innerHTML = `<li class="selectLi"><div id="lastSelectLi"><input type="radio" name="estimate_agegroup" class="radio" value="50대 이상"><p>50대 이상</p></div></li>`;
            document.getElementById('selectUl').appendChild(label4);
            document.getElementById('value').value = 2;
            document.getElementById('selectBarAni').animate([    
                { width: "128px"} 
        ...
        case '5':
            ...
            document.getElementsByClassName('selectLi')[0].innerHTML = `<div id="firstSelectLi"><input type="radio" name="estimate_mgender" class="radio" value="무관"><p>무관</p></div>`;
            document.getElementsByClassName('selectLi')[1].innerHTML = `<div><input type="radio" name="estimate_mgender" class="radio" value="남자"><p>남자</p></div>`;
            document.getElementsByClassName('selectLi')[2].innerHTML = `<div id="lastSelectLi"><input type="radio" name="estimate_mgender" class="radio" value="여자"><p>여자</p></div>`;
            document.getElementsByClassName('selectLi')[6].remove();
            document.getElementsByTagName('label')[6].remove();
            document.getElementsByClassName('selectLi')[5].remove();
            document.getElementsByTagName('label')[5].remove();
